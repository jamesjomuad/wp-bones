<h2 class="font-medium text-3xl my-10">Navigation</h2>

<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Simple</h3>
...
<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Responsive Header</h3>
...
<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Tab</h3>
...
<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Pill</h3>
    <ul class="flex">
        <li class="mr-3">
...
<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Stretched</h3>
    <ul class="flex">
...
<div class="container p-4">
    <h3 class="my-8 font-medium text-xl">Justified</h3>
